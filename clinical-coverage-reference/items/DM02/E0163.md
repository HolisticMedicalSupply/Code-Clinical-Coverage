...
icd10_primary:
  - "Z99.3 - Dependence on wheelchair (Inferred)"
  - "R26.2 - Difficulty in walking, not elsewhere classified (Inferred)"
  - "M25.50-M25.579 - Pain in joint (Inferred)"
  - "R26.89 - Other abnormalities of gait and mobility (Inferred)"
  - "G82.20-G82.54 - Paraplegia and tetraplegia (Inferred)"
  - "I69.x - Sequelae of cerebrovascular disease (Inferred)"

# Coverage Requirements - Structured for comparison tables
medicare:
  covered: true
  prior_auth: false  # (Inferred - not mentioned in source, typical for standard DME)
...
medicaid_nassau:
  ...
  frequency_code: "F3"
  frequency_limit: "Once every 3 years (Inferred from F3 code)"
  quantity_limit: "1 per patient (Under Review)"
...
data_quality:
  ...
  source_verified_fields: ["covered", "dvs_authorization", "documentation_type", "frequency_code", "modifiers", "clinical_indications"]
  inferred_fields: ["icd10_primary", "prior_auth_medicare", "frequency_limit_wording"]
